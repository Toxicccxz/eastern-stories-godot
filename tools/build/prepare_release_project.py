...
REQUIRED_PATHS = (
    ...
    "runtime/application/godot_safe_area_capability.gd",
    "application/input/mobile_touch_capability.gd",
    "application/input/touch_capture_state.gd",
    "runtime/application/mobile_touch_adapter.gd",
    "runtime/application/android_back_adapter.gd",
    "runtime/application/application_exit_capability.gd",
    "presentation/layout/safe_area_metrics.gd",
    "presentation/layout/safe_area_capability.gd",
    "presentation/layout/safe_area_presenter.gd",
    "presentation/layout/responsive_panel_layout.gd",
    "presentation/layout/application_shell_layout.gd",
    "presentation/layout/oldpine_hud_layout.gd",
    "scenes",
