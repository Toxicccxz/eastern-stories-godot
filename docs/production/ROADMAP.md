...
9. **Source-valid New Game Entry — NGE3 IMPLEMENTATION COMPLETE / AWAIT OWNER REVIEW**
   ...
   focused regressions and desktop keyboard/collision proof pass. Population/services, remaining exits and
   ...
   Canonical17,377 and real desktop round trip PASS; eroad3 south remains closed, no Old Pine link.
   ...
   acceptance. Keep current New Game untouched; no PR/merge or automatic NGE4 implementation.
